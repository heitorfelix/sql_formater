...
def format_sql(sql, reindent_aligned, keyword_case, use_space_around_operators, strip_comments):
...
if st.button("Formatar"):
    if sql_input:
        formatted_sql = format_sql(sql_input, reindent_aligned, keyword_case, use_space_around_operators, strip_comments)
